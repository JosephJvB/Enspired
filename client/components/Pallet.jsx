...
const Pallet = (props) => {
  return (
    <div id='pallet'>
      ...
      <button id='greenBut' className='button is-large' onDoubleClick={() => props.sb('green')} onClick={() => props.cc('green', props.side)}></button>
      ...
      <button id='pinkBut' className='button is-large' onDoubleClick={() => props.sb('pink')} onClick={() => props.cc('pink', props.side)}></button>
      ...
      <button id='purpleBut' className='button is-large' onDoubleClick={() => props.sb('purple')} onClick={() => props.cc('purple', props.side)}></button>
